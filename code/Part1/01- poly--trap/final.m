...
XNP = 3.; %effective navigation ratio [dimensionless]
RM1 = 0.; %initial location of the missile (in the dowenrange axis)[ft]
RM2 = 9000.; %initial location of the missile (in the crossrange axis)[ft]
