...
{
	int step;
	float vm,xncg,alt,a,diam,fr,xl,ctw,crw,hw,ctt;
	float crt,ht,xn,xcg,xhl,wgt,xkr,rho,swing,stail,sref;
	float xlp,splan,xcpn,an,ab,xcpb,xcpw,xmach;
	float xiyy,tmp1,tmp2,tmp3,tmp4,b,q,p1,y1,y2,y3;
	float y4,y5,y6,p2,p3,alftr,deltr,cna,cnd,cmap,cma,cmd;
	float xma,xmd,za,zd,wz,waf,zaf,xk1,xk2,ta,xk3,xkdc,e,ed;
	float t,h,s,eold,edold,edd,xnl,del,thd;
	FILE *fptr;
