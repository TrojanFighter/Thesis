...
{
	int qboost,step;
	double xisp1,xisp2,xmf1,xmf2,wpay,delv,delv1,delv2,amax1,amax2,top2,bot2;
	double wp2,ws2,wtot2,trst2,tb2,top1,bot1,wp1,ws1,wtot,trst1,tb1,delvk;
	double h,t,s,a,gm,altnm,alt,angdeg,ang,xlongm,x,y,xfirst,yfirst,x1,y1;
	double axt,ayt,xlongtdeg,xlongt,xf,yf,tf,xold,yold,x1old,y1old;
	double xd,yd,x1d,y1d,tgolam,delx,dely,del;
	double velk,gamdeg,xnm,ynm,wgt,trst,at,tembot,vrx,vry,distnm;
	FILE *fptr;
