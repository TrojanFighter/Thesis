...
%lambda = pi - atan2((yT - yA),(xA - xT))

%theta  = atan2((yT - yA),(xA - xT))
...
%phi_hat = phi + lambda
%psi_hat = psi + theta + lambda - pi
%xi_hat  =  lambda + theta - xi

phi_hat = 2.7033;
psi_hat = 0.7115;
xi_hat  = 2.4301;

%SOLVE FOR y -- intersection point coordinate
c4 = 1 - alpha^2;
c3 = -2*(1 - alpha^2) * yT;
...
tx1 = text(xT(1)+0.25,yT(1)+0.25,txt1); tx1.FontSize = 20;
tx2 = text(xA(1)-0.25,yA(1)-0.25,txt2); tx2.FontSize = 20;
tx3 = text(xD(1)+0.25,yD(1)-0.25,txt3); tx3.FontSize = 20;
