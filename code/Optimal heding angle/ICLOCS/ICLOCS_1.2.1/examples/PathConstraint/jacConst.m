...
df.dt{1}=[];             % Derivatives of f(x,u,p,t) wrt. t

df.dx{1}=[0*Lt  0*Lt];      % Derivatives of f(x,u,p,t) wrt. x1
df.dx{2}=[1*Lt , -1*Lt];    % Derivative of f(x,u,p,t) wrt. x2

df.du{1}=[0*Lt, 1*Lt];  % Derivative of f(x,u,p,t) wrt. u1
